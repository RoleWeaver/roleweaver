...
class NWNAIApp:
    ...
    def _build_ui(self):
        ...
        ttk.Label(
            controls,
            text="Wayland: use the buttons, then copy the editable game-language draft into NWN." if core.is_wayland() else "F8 creates candidates; F9 creates one reply. Translate, edit, then paste the game-language draft into NWN.",
            wraplength=320,
