...
class NWNAIApp:
    ...
    def _build_ui(self):
        ...
        ttk.Label(
            controls,
            text="Wayland: use the buttons to generate and copy drafts. Open NWN chat and paste with Ctrl+V. Global hotkeys are unavailable." if core.is_wayland() else "F8 creates drafts here. F9: after generation, click NWN during the 2-second countdown; the draft is pasted but not sent.",
            wraplength=320,
    ...
    def _build_guardrail_policy_page(self, frame):
        self.guardrail_purpose_labels = {
            ...
            "Summaries": "summary", "AFK": "afk", "Translations": "translation",
