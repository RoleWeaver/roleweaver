...
Read [release notes](RELEASE_NOTES_v1.3.0.md), [game selection](GAME_VERSIONS.md),
[NWN2 logging](NWN2_LOGGING.md), [AFK](AFK_MODE.md) and [testing](TESTING_v1.3.0.md).
