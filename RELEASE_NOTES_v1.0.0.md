...
**RoleWeaver-Setup-v1.0.0.exe** is the recommended Windows download. It installs Role Weaver like a normal application and does not require Python.

A portable ZIP is also provided for users who prefer not to install the application.

## Highlights

- Player-character and DM/NPC profiles
- Google Gemini, OpenAI, and local LM Studio support
- Editable AI drafts and multiple candidate replies
- F9 generate-and-paste workflow that leaves the reply unsent for human review
- Persistent Guidance
...
2. Select an AI provider and enter its API key if required.
3. Press **Test AI Connection**.
4. Create or select a character profile.
5. Select the NWN server profile and client log.
6. Start Role Weaver.
7. Enter NWN and roleplay.

See `FIRST_RUN.md` and `AI_PROVIDER_SETUP.md` for more detail.
